...
import { validateDocument, formatDocument } from '@/lib/validations';
...
export default function CustomerDetailPage() {
  ...
  const loadEntity = async (token: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setEntity(data);
        // Initialize validation state for existing document
  ...
  // Load audit log when showing the history tab
  ...
  // Real-time document validation on blur
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-primary">Detalhes do Cliente</h1>
              <p className="text-gray-600 mt-1">Visualize e edite as informações do cliente</p>
            </div>
