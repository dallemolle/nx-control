...
export default function SupplierDetailPage() {
  ...
  const loadEntity = async (token: string) => {
    ...
    try {
      ...
      console.error('Erro ao carregar fornecedor');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (!entity) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-red-500">Fornecedor não encontrado</div>
      </div>
    );
  }
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-primary">Detalhes do Fornecedor</h1>
              <p className="text-gray-600 mt-1">Visualize e edite as informações do fornecedor</p>
            </div>
